...
<div class="h-100 bg-cover bg-center py-5 d-flex align-items-center" style="background-image: ">
    <div class="container">
        <div class="row">
                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            <img src="{{ static_asset('assets/img/smart-payroll.png') }}" class="mw-100 mb-4" height="40">
