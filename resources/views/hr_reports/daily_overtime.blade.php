...
<div class="row">
    <div class="col-12 text-center">
        <button type="button" class="btn btn-success mt-2 mb-4" id="daily_overtime_report">Submit</button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#daily_overtime_report').click(function() {
            ...
            $.ajax({
                ...
                type:"POST",
                url:'{{ route('daily.overtime.report') }}',
                data: {
                    'from_date': from_date,
                ...
                success: function(data) {
                    ...
                    link.download="daily_overtime_report.pdf";
                    link.click();
                },
                error: function(blob){
                    console.log(blob);
