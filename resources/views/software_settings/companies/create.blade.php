            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('companies.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="owner_name" class="form-control" id="name" placeholder="Owner name" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="website" class="form-control" id="website" placeholder="Wesite" required>
                        </div>
                    </div>
