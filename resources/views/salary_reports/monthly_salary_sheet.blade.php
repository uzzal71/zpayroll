...
<div class="row">
    <div class="col-12 text-center">
        <button type="button" class="btn btn-success mt-2 mb-4" id="monthly_salary_sheet_report">Submit</button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#monthly_salary_sheet_report').click(function() {
            ...
            $.ajax({
                ...
                type:"POST",
                url:'{{ route('monthly.salary.sheet.report') }}',
                data: {
                    'month': month,
                    'year': year,
